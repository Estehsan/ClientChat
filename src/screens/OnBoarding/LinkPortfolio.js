...
export default function App({ ...props }) {
  return (
    <View style={styles.getStarted}>
      ...
      <View>
        <Text style={styles.Stockchat}> CONNECT YOUR PORTFOLIO</Text>
      </View>
      <View>
        <Text style={styles.username}>
          You'll get added to new groups based on your portfolio stocks. Dollar
          amounts are never shared publicly.
        </Text>
      </View>
